...
static void print_exp( int n_spaces, Exps *exp );
...
static void print_new( int n_spaces, Type *type, Exps *exp) {
    printf("NEW {\n");
...
static void print_as( int n_spaces, Exps *exp, Type *type) {
    printf("AS {");
    print_spaces( n_spaces + TABSTOP, 1);
    printf("TYPE ");
    print_type( type );
...
static void print_expatt( int n_spaces, Exps *e1, Exps *e2) {
    printf("ASSIGN {\n");
...
static void print_or( int n_spaces, Exps *e1, Exps *e2 ) {
    printf("OR {\n");
    print_exp( n_spaces + TABSTOP, e1 );
    puts("");
    print_exp( n_spaces + TABSTOP, e2 );
...
static void print_and( int n_spaces, Exps *e1, Exps *e2 ) {
    printf("AND {\n");
    print_exp( n_spaces + TABSTOP, e1 );
    puts("");
    print_exp( n_spaces + TABSTOP, e2 );
...
static void print_not( int n_spaces, Exps *e1 ) {
    printf("NOT {\n");
    print_exp( n_spaces + TABSTOP, e1 );
    print_spaces( n_spaces, 1);
    printf("}");
...
static void print_eq( int n_spaces, Exps *e1, Exps *e2 ) {
    printf("EQUALS {\n" );
    print_exp( n_spaces + TABSTOP, e1 );
    puts("");
    print_exp( n_spaces + TABSTOP, e2 );
...
static void print_neq( int n_spaces, Exps *e1, Exps *e2 ) {
    printf("NOT EQUAL {\n" );
    print_exp( n_spaces + TABSTOP, e1 );
    puts(""); 
    print_exp( n_spaces + TABSTOP, e2 );
...
static void print_geq( int n_spaces, Exps *e1, Exps *e2 ) {
...
static void print_leq( int n_spaces, Exps *e1, Exps *e2 ) {
...
static void print_less( int n_spaces, Exps *e1, Exps *e2 ) {
    printf("LESS {\n" );
    print_exp( n_spaces + TABSTOP, e1 );
    puts("");
    print_exp( n_spaces + TABSTOP, e2 );
...
static void print_greater( int n_spaces, Exps *e1, Exps *e2 ) {
    printf("GREATER {\n" );
    print_exp( n_spaces + TABSTOP, e1 );
    puts("");
    print_exp( n_spaces + TABSTOP, e2 );
...
static void print_sum( int n_spaces, Exps *e1, Exps *e2 ) {
    printf("SUM {\n" );
    print_exp( n_spaces + TABSTOP, e1 );
    puts("");
    print_exp( n_spaces + TABSTOP, e2 );
...
static void print_sub( int n_spaces, Exps *e1, Exps *e2 ) {
    printf("SUB {\n" );
    print_exp( n_spaces + TABSTOP, e1 );
    puts("");
    print_exp( n_spaces + TABSTOP, e2 );
...
static void print_mul( int n_spaces, Exps *e1, Exps *e2 ) {
    printf("MUL {\n" );
    print_exp( n_spaces + TABSTOP, e1 );
    puts("");
    print_exp( n_spaces + TABSTOP, e2 );
...
static void print_div( int n_spaces, Exps *e1, Exps *e2 ) {
    printf("DIV {\n" );
    print_exp( n_spaces + TABSTOP, e1 );
    puts("");
    print_exp( n_spaces + TABSTOP, e2 );
...
static void print_expvar( int n_spaces, Exps *e1, Exps *e2) {
...
static void print_minus( int n_spaces, Exps *e1 ) {
    printf("MINUS {\n");
    print_exp( n_spaces + TABSTOP, e1 );
    print_spaces( n_spaces, 1);
    printf("}");
...
static void print_if( int n_spaces, Exps *exp, Stat *stat ) {
    print_spaces(n_spaces, 0);
    printf("IF (\n");
    print_exp( n_spaces + TABSTOP, exp);
    print_spaces( n_spaces, 1);
...
static void print_ifelse ( int n_spaces, Exps *exp, Stat *stat, Stat *stat2 ) {
...
static void print_retexp( int n_spaces, Exps *exp ) {
    print_spaces( n_spaces, 0 );
    printf("RETEXP {\n");
    print_exp( n_spaces + TABSTOP, exp);
    print_spaces( n_spaces, 1);
...
static void print_while ( int n_spaces, Exps *exp, Stat *stat ) {
    print_spaces( n_spaces, 0 );
    printf("WHILE (\n");
    print_exp( n_spaces + TABSTOP, exp);
    print_spaces( n_spaces, 1);
...
static void print_print( int n_spaces, Exps *exp ) {
    print_spaces( n_spaces, 0 );
    printf("PRINT {\n");
    print_exp( n_spaces + TABSTOP, exp);
    print_spaces( n_spaces, 1);
